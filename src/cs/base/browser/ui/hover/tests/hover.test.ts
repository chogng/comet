...
let createHoverController: typeof import('cs/base/browser/ui/hover/hover').createHoverController;
let createHoverService: typeof import('cs/base/browser/ui/hover/hover').createHoverService;
...
before(async () => {
  ...
  ({ createHoverController } = await import('cs/base/browser/ui/hover/hover'));
  ({ createHoverService } = await import('cs/base/browser/ui/hover/hover'));
