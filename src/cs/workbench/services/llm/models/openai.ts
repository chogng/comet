...
const openai: ReadonlyArray<LlmModelDefinition> = [
  {
    ...
    id: 'gpt-5.5',
    label: 'GPT-5.5',
    description: 'OpenAI flagship model for agentic, coding, and professional workflows.',
  ...
  },
  {
    ...
    id: 'gpt-5-codex',
    label: 'GPT-5 Codex',
    description: 'Codex-tuned model for coding-heavy chat and reasoning tasks.',
    knowledge_cutoff_date: '2025-08-31',
    supports_image_input: true,
