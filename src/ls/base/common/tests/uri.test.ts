...
import { createURITransformer } from 'ls/base/common/uriTransformer';
import { transformAndReviveIncomingURIs } from 'ls/base/common/uriIpc';
import { UriTemplate } from 'ls/base/common/uriTemplate';
