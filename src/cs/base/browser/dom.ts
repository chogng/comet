...
class SizeUtils {
	...
	private static convertToPixels(_element: HTMLElement, value: string): number {
...
const globalCustomElements = globalThis.customElements ?? mainWindow.customElements;
if (globalCustomElements && !globalCustomElements.get('connection-observer')) {
	globalCustomElements.define('connection-observer', ConnectionObserverElement);
}
