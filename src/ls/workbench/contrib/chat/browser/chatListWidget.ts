...
import type { AssistantChatMessage } from 'ls/workbench/browser/assistantModel';
...
import { AgentChatThreadRenderer } from 'ls/workbench/contrib/chat/browser/chatListRenderer';
