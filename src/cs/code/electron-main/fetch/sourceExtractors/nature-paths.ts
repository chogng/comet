import { isNatureListingPage } from 'cs/code/electron-main/fetch/sourceExtractors/nature-listing-shared';
import { createNatureResearchArticlesCandidateExtractor } from 'cs/code/electron-main/fetch/sourceExtractors/nature-research-articles';
