...
import type { SyncDescriptor0 } from 'ls/platform/instantiation/common/descriptors';
import type { ServiceCollection } from 'ls/platform/instantiation/common/serviceCollection';
