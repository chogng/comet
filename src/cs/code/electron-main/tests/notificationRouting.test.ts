...
import type { NativeToastOptions, NativeToastType } from 'cs/base/parts/sandbox/common/sandboxTypes';
import {
...
} from 'cs/code/electron-main/notificationRouting';
...
test('resolveSystemNotificationPayloadFromToast trims message and maps titles by type', () => {
  ...
  const byType = new Map<NativeToastType, string>([
    ['info', 'Comet Studio'],
    ['success', 'Comet Studio Completed'],
    ['warning', 'Comet Studio Warning'],
    ['error', 'Comet Studio Error'],
  ]);
