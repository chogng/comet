import type { AppSettings, NativeToastOptions, NativeToastType } from 'cs/base/parts/sandbox/common/sandboxTypes';
...
function resolveSystemNotificationTitle(type: NativeToastType) {
  switch (type) {
    case 'error':
      return 'Comet Studio Error';
    case 'warning':
      return 'Comet Studio Warning';
    case 'success':
      return 'Comet Studio Completed';
    default:
      return 'Comet Studio';
  }
}
