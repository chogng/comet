import type { ThemeColorDefaults } from 'cs/platform/theme/common/theme';
...
export type ColorIdentifier =
  ...
  | 'sideBar.background'
  | 'sideBar.fetchCardBorder'
  | 'sideBar.fetchCardHoverBackground'
  | 'sideBar.fetchCardFocusBorder'
  | 'sideBar.fetchCardSelectedBackground'
  | 'sideBar.fetchCardSelectedHoverBackground'
  | 'sideBar.fetchCardSelectedBorder'
  | 'sideBar.fetchCardTitleForeground'
  | 'sideBar.fetchCardMetaForeground'
  | 'sideBar.fetchCardBodyForeground'
  | 'sideBar.fetchCardStrongForeground'
  | 'sideBar.emptyStateForeground'
  | 'sideBar.linkForeground'
  | 'sideBar.linkHoverForeground'
  | 'agentBar.background'
  | 'agentBar.inputBorder'
  | 'agentBar.inputBackground'
  | 'agentBar.inputForeground'
  | 'chatInput.composerBorder'
  | 'chatInput.composerBackground'
  | 'chatInput.composerToolbarBorder'
  | 'chatInput.composerToolbarBackground'
