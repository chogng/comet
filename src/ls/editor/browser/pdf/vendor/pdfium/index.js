var createPdfium = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      throw new Error('The vendored PDFium runtime is browser-only.');
    ...
    (Module['_EPDFAnnot_SetAppearanceFromPage'] =
      createExportWrapper('EPDFAnnot_SetAppearanceFromPage', 3));
    (Module['_EPDFAnnot_ExportAppearanceAsDocument'] =
...
const DEFAULT_PDFIUM_WASM_URL = 'pdfium.wasm';
