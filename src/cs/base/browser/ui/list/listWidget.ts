...
class TraitRenderer<T> implements IListRenderer<T, ITraitTemplateData> {
	...
	renderElement(_element: T, index: number, templateData: ITraitTemplateData): void {
...
class AccessibiltyRenderer<T> implements IListRenderer<T, IAccessibilityTemplateData> {
	...
	renderElement(element: T, _index: number, data: IAccessibilityTemplateData): void {
	...
	disposeElement(_element: T, _index: number, templateData: IAccessibilityTemplateData): void {
