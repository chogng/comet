...
/** Parses a Writing Editor document and rejects values outside the Editor schema. */
export function parseWritingEditorDocument(value: unknown): WritingEditorDocument {
