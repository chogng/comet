...
import {
  ...
  getMenuActions,
  registerAction2,
} from 'ls/platform/actions/common/actions';
import { commandService } from 'ls/platform/commands/common/commands';
import { KeybindingsRegistry } from 'ls/platform/keybinding/common/keybindingsRegistry';
