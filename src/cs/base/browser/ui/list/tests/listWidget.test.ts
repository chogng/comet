...
import type { IListRenderer, IListVirtualDelegate } from 'cs/base/browser/ui/list/list';

let cleanupDomEnvironment: (() => void) | null = null;
let List: typeof import('cs/base/browser/ui/list/listWidget').List;
...
before(async () => {
	...
	({ List } = await import('cs/base/browser/ui/list/listWidget'));
});
