...
import { extractDomainFromUri, isDomainAllowed } from './domainMatcher';
import { AgentNetworkDomainSettingId } from './settings';
...
export class AgentNetworkFilterService extends Disposable implements IAgentNetworkFilterService {
	...
	private readonly domainCache = new Map<string, boolean>();
