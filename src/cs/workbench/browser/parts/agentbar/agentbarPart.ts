...
import { AgentChatWidget } from 'cs/workbench/contrib/chat/browser/chatWidget';
...
export type { AgentChatWidgetProps } from 'cs/workbench/contrib/chat/browser/chatWidget';
