...
import { parse, ParseErrorCode, type ParseError } from 'cs/base/common/json';
import { getParseErrorMessage } from 'cs/base/common/jsonErrorMessages';
import { parse as parseJsonc } from 'cs/base/common/jsonc';
