...
test support under this folder. Refer to the linked documentation for how each
test surface is written and run:

- Unit tests: `*.test.ts` beside their owning modules or under the owning
  `test` directory ([guidelines](../.github/instructions/writing-test.instructions.md)).
