...
import { truncate } from 'cs/base/common/strings';
import { ThemeIcon } from 'cs/base/common/themables';
import { URI } from 'cs/base/common/uri';
import { generateUuid } from 'cs/base/common/uuid';
import { BrowserViewUri } from 'cs/platform/browserView/common/browserViewUri';
import { BrowserViewSharingState, INavigateOptions, IBrowserEditorViewState, IBrowserViewWorkbenchService } from 'cs/workbench/contrib/browserView/common/browserView';
import { EditorInputCapabilities, IEditorSerializer, IUntypedEditorInput, Verbosity } from 'cs/workbench/common/editor';
...
import { TAB_ACTIVE_FOREGROUND } from 'cs/workbench/common/theme';
import { localize } from 'cs/nls';
import { IInstantiationService } from 'cs/platform/instantiation/common/instantiation';
import { IBrowserViewModel } from 'cs/workbench/contrib/browserView/common/browserView';
import { hasKey } from 'cs/base/common/types';
import { ITelemetryService } from 'cs/platform/telemetry/common/telemetry';
import { logBrowserOpen } from 'cs/platform/browserView/common/browserViewTelemetry';
import { LRUCachedFunction } from 'cs/base/common/cache';
import { Disposable, DisposableStore, IDisposable } from 'cs/base/common/lifecycle';
