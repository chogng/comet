...
import type { ILocalConnectedAgentPackageProduct } from 'cs/platform/agentHost/node/packages/agentPackageProducts';
...
export interface IMockAgentPackageProduct extends ILocalConnectedAgentPackageProduct {
