...
import { StorageScope } from 'cs/platform/storage/common/storage';
...
import { IWorkbenchStorageService } from 'cs/workbench/services/storage/common/storage';
...
export class WorkbenchStorageService
	...
	implements IWorkbenchStorageService
{
