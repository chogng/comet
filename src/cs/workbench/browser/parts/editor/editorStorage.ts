import { createEmptyWritingEditorDocument, createWritingEditorDocumentFromPlainText, normalizeWritingEditorDocument, writingEditorDocumentToPlainText } from 'cs/editor/common/writingEditorDocument';
...
const storageKeys = {
  title: 'cs.writingDraft.title',
  body: 'cs.writingDraft.body',
  document: 'cs.writingDraft.document',
  viewMode: 'cs.writingDraft.viewMode',
  workspace: 'cs.writingWorkspace.state',
} as const;
