const zh = {
  ...
  settingsPageUrl: '已适配的期刊来源',
  settingsPageUrlHint: '期刊名补全以导出docx时展示分组',
  addBatchUrl: '添加 URL',
  removeBatchUrl: '删除 URL',
  moveBatchUrlUp: '上移',
  moveBatchUrlDown: '下移',
  settingsBatchJournalTitle: '期刊名',
  batchJournalTitlePlaceholder: '期刊名',
  settingsBatchSourceOptimized: '已优化',
  settingsBatchSourcesEdit: '修改',
  settingsBatchSourcesDone: '保存',
  settingsBatchSourcesShow: '显示',
  settingsBatchSourcesHide: '隐藏',
  ...
  settingsTranslationProviderHint:
    '\u9009\u62e9\u6587\u732e\u5bfc\u51fa\u7ffb\u8bd1\u65f6\u4f7f\u7528 GLM AI\uff0c\u8fd8\u662f\u4e13\u7528\u7ffb\u8bd1 API\u3002',
  settingsTranslationProviderDeepL: 'DeepL',
  settingsTranslationProviderGlm: 'GLM \u7ffb\u8bd1 AI',
  settingsTranslationProviderOpenAICompatible: 'OpenAI-compatible',
  settingsTranslationProviderGlmHint:
    '\u8fd9\u91cc\u7684 API Key \u548c\u6a21\u578b\u4f1a\u4e0e\u201c\u6a21\u578b\u201d\u9875\u7684 GLM provider \u5171\u7528\u3002DOCX \u5bfc\u51fa\u7ffb\u8bd1\u4f1a\u76f4\u63a5\u8c03\u7528 GLM\u3002',
  settingsTranslationProviderOpenAICompatibleHint:
    '\u4f7f\u7528 OpenAI-compatible chat completions\uff0c\u56fa\u5b9a\u6a21\u578b GPT-5.4 Mini\u3002\u8fd9\u91cc\u5355\u72ec\u914d\u7f6e Base URL \u548c API Key\u3002',
